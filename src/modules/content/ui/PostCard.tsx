...
export function PostCard({ post }: PostCardProps) {
  ...
  return (
    <article className="group rounded-lg border border-gray-200 bg-white shadow-sm transition-all duration-200 hover:border-gray-300 hover:shadow-md overflow-hidden">
      <div className="p-6">
